...
class TestTimelinePost(unittest.TestCase):
    ...
    def tearDown(self):
        # Not strictly necessary since SQLite in-memory databases only live # for the duration of the connection, and in the next step we close 
    ...
    def test_timeline_post(self):
        ...
        # Get all timeline posts and assert that they are correct
